...
export function DialogDetails({ open, data, setOpen }: DialogDataProps<{ email: string, password: string, confirmPassword: string }>) {
    ...
    return (
        <>
            ...
            <DialogMessage data={userResponse} open={openMessage} setOpen={setOpenMessage}></DialogMessage>
        </>
    );
}